...
def S1_estimateModel(hlTercets, eps=0.1):
    ...
    # hlTercets è il dizionario dei canti che sono liste di terzine
...
if __name__ == '__main__':
    ...
    S1_predictions = compute_classPosteriors(
        S1_compute_logLikelihoodMatrix(S1_model, lTercetsEval, hCls2Idx),
    ...
    lTercetsEval = lInfEval + lPurEval
    ...
    labelsEval = numpy.hstack([labelsInf, labelsPur])

    print('Binary [inferno vs purgatorio] - S2 - Accuracy:', compute_accuracy(S2_predictions, labelsEval))
